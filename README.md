...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/wild-thunder-3218
```

A live public deployment of this template is available at [https://wild-thunder-3218.templates.workers.dev](https://wild-thunder-3218.templates.workers.dev)
